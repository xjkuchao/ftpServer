...
class SslServer : public QTcpServer {
  ...
  private:
    ...
    // QTcpServer::incomingConnection(qintptr handle) this 2nd one is sneaky as
    // it compiles properly but no connections appear to arrive since the
    // compiler doesn’t consider int and qintptr the same.
